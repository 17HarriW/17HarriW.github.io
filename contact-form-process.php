...
if (isset($_POST['Email'])) {
    ...
    $email_to = "willharris0811@gmail.com";
    $email_subject = "Portfolio contact";

    function problem($error)
    {
        echo "I apologise, but there were error(s) found with the form you submitted. ";
    ...
    if (
        ...
        problem('I apologise, but there appears to be a problem with the form you submitted.');
    }
